...
const ctaFirstname = document.querySelector('.cta-firstname');
const ctaLastname = document.querySelector('.cta-lastname');
const ctaEmail = document.querySelector('.cta-email');
const ctaTelephone = document.querySelector('.cta-telephone');

const menuBtn = document.getElementById('menu-btn');
const sideEl = document.getElementById('nav-el');
let sideActive = false;
const submitLoginFormBtn = document.querySelector('.btn-submit-login-form');
...
const userOne = {
  firstName: 'mike',
  lastName: 'beyt',
  email: 'beitisamichael@gmail.com',
};
...
const ctaBtnSubmit = document.querySelector('.btn-cta-join-submit');
//menubtn//
...
submitLoginFormBtn.addEventListener('click', function () {
  if (
    ...
    loginForm.style.transition = '1000ms';
    loginBtn.style.display = 'none';
    profileBtn.style.display = 'block';
    profileBtn.style.transition = '500ms';
  }
});

/*
const addUsers = function (ctaFirstname, ctaLastname, ctaEmail, ctaTelephone) {
  users.firstName = ctaFirstname.value;
  users.lastName = ctaLastname.value;
  users.email = ctaEmail.value;
  users.telephone = ctaTelephone.value;
};
*/

ctaBtnSubmit.addEventListener('click', function () {});
